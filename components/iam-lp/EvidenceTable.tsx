...
export function EvidenceTable({ gap }: EvidenceTableProps) {
  ...
  const rows: Array<{ label: string; value: string }> = [
    { label: "Observation window", value: gap.observation_days === null ? "Unknown" : `${gap.observation_days} days` },
    { label: "API events found", value: gap.summary.cloudtrail_events === null ? "Unknown" : `${gap.summary.cloudtrail_events}` },
    {
