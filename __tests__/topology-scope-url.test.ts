...
describe("topology scope URLs", () => {
  ...
  it("builds client cache key v12", () => {
    expect(
    ...
    ).toBe("topology-risk:alon-prod:v12:745783559495:eu-west-1:vpc-abc")
  })
  ...
  it("keeps customer graph planes separate end to end", () => {
    ...
    expect(buildTopologyRiskCacheKey("testbed-webshop", scope)).toBe(
      "topology-risk:testbed-webshop:testbed-webshop:v12:::all",
    )
