...
function artifact(): ChangeCaseArtifact {
  return {
    schema_version: 'change-case/v1', case_id: 'cc-download', generated_at: '2026-08-12T00:00:00Z',
    ...
    evidence: { accepted_flow_log_records: 0, accepted_records_are_application_use: false, rule_unique_source_count: null, rule_unique_source_count_kind: 'UNKNOWN', rule_unique_source_count_display: 'Unknown', requested_days: 90, effective_days: 90, complete: true, gaps: [] },
    ...
    approval_report: { format: 'text/markdown', filename: 'cc-download.md', content: '# Approval report\nExact plan' },
  }
}
...
describe('Change Case approval report', () => {
  it('downloads the frozen Markdown bytes with the case filename', () => {
    ...
    try {
      ...
      fireEvent.click(screen.getByText('Generate approval report'))
