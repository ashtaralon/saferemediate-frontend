...
- Name: topology-estate-c1-qa-live.spec.ts >> C1 live QA — Step 5 acceptance matrix >> five reloads: the map mounts every time and the scope never silently drops
- Location: tests/integration/topology-estate-c1-qa-live.spec.ts:1604:7
