...
```
Error: the external-destinations panel never settled at opacity 1 (1600x900 · measurement). Chain: div topology-external-destinations-details opacity=1 animation=enter/running transition=all | div popper-wrapper opacity=1 animation=none/running transition=all | body font-sans antialiased opacity=1 animation=none/running transition=all
```
