...
- Name: topology-estate-semantics-fixture.spec.ts >> the egress chain names the map's own gateway, so the continuation is the IGW the map draws
- Location: tests/integration/topology-estate-semantics-fixture.spec.ts:85:5
