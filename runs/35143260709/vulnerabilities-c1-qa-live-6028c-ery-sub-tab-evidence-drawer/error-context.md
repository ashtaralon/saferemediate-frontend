...
- Name: vulnerabilities-c1-qa-live.spec.ts >> C1 live QA — Risk › Vulnerabilities against the deployed graph >> Risk › Vulnerabilities on the deployed frontend: KPIs, banner, every sub-tab, evidence drawer
- Location: tests/integration/vulnerabilities-c1-qa-live.spec.ts:266:7
