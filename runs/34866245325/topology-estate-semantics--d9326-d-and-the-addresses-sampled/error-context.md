...
Locator:  getByTestId('topology-external-destinations-details').getByTestId('topology-external-destination-leg').filter({ hasText: 'all 3 shown' })
Expected: 1
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByTestId('topology-external-destinations-details').getByTestId('topology-external-destination-leg').filter({ hasText: 'all 3 shown' })
...
- generic [ref=e1]:
  ...
  - dialog [active] [ref=e1323]:
    ...
    - list [ref=e1326]:
      - listitem [ref=e1327]:
        - text: i-0e9b891793b5b2dbd · 3 distinct · 4 of 3 shown
        - generic [ref=e1328]: — 54.217.69.183, 54.217.245.46, 3.253.225.145, 52.218.0.200
      - listitem [ref=e1329]:
        - text: i-0f51b8b7ad29a359b · 532 distinct · 5 of 532 shown
        - generic [ref=e1330]: — 3.5.73.1, 3.5.72.73, 3.5.72.119, 3.5.69.34, 3.5.67.254
      - listitem [ref=e1331]:
