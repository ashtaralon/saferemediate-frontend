...
- Name: topology-estate-fullscreen-stacking-fixture.spec.ts >> external-destinations panel is topmost inside map fullscreen at 1366x768
- Location: tests/integration/topology-estate-fullscreen-stacking-fixture.spec.ts:136:7

# Error details

```
Error: the panel never settled opaque and on top in fullscreen (1366x768 · measurement): {"hasWrapper":true,"wrapperZ":50,"contentZ":50,"fullscreenZ":200,"panelInsideFullscreen":false,"effectiveOpacity":1,"rect":{"x":871,"y":242,"w":460,"h":300},"covered":[{"probe":"top","x":1101,"y":248,"hit":"div.text-[11px] uppercase tracking-[0.14em] font-sem"},{"probe":"middle","x":1101,"y":392,"hit":"topology-interlane-corridor"},{"probe":"bottom","x":1101,"y":536,"hit":"topology-interlane-corridor"},{"probe":"left","x":877,"y":392,"hit":"div.text-[9px] uppercase tracking-[0.12em] font-semi"},{"probe":"right","x":1325,"y":392,"hit":"div.flex flex-col gap-1 max-w-full"}]}
```
