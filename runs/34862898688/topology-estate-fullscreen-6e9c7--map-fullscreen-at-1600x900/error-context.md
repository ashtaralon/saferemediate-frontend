...
```
Error: the panel never settled opaque and on top in fullscreen (1600x900 · measurement): {"hasWrapper":true,"wrapperZ":50,"contentZ":50,"fullscreenZ":200,"panelInsideFullscreen":false,"effectiveOpacity":1,"rect":{"x":988,"y":224,"w":460,"h":300},"covered":[{"probe":"top","x":1218,"y":230,"hit":"div.text-[11px] uppercase tracking-[0.14em] font-sem"},{"probe":"middle","x":1218,"y":374,"hit":"div.text-[9px] uppercase tracking-[0.12em] font-semi"},{"probe":"bottom","x":1218,"y":518,"hit":"topology-service-node-icon"},{"probe":"left","x":994,"y":374,"hit":"topology-region-fill-grid"},{"probe":"right","x":1442,"y":374,"hit":"topology-density-stack-tile"}]}
```
