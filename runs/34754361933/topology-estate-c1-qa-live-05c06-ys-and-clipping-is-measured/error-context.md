...
- Name: topology-estate-c1-qa-live.spec.ts >> C1 live QA — Step 5 acceptance matrix >> viewport 1600x900: the page never scrolls sideways, and clipping is measured
- Location: tests/integration/topology-estate-c1-qa-live.spec.ts:1444:9

# Error details

```
Error: 1600x900: no subnet tiers or cells rendered — the measurement would be vacuous
