...
- Name: vulnerabilities-c1-qa-live.spec.ts >> C1 live QA — Risk › Vulnerabilities against the deployed graph >> vulnerability-map on the deployed backend: counts, coverage, per-node evidence
- Location: tests/integration/vulnerabilities-c1-qa-live.spec.ts:133:7
