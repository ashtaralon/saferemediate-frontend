...
// SG-9h: proxy route for POST /api/sg/shared-sgs/{sg_id}/disable-staged.
...
export async function POST(
  ...
  const backendUrl = `${BACKEND_URL}/api/sg/shared-sgs/${encodeURIComponent(sg_id)}/disable-staged`
