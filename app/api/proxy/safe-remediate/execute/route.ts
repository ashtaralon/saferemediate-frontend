...
export async function POST(request: NextRequest) {
  try {
    ...
    const { finding_id, create_rollback = true } = body

    console.log(`[SAFE-REMEDIATE] Executing: ${finding_id}`)
    ...
    try {
      ...
      console.log(`[SAFE-REMEDIATE] Backend unavailable, using local execution`)
    }
    ...
    console.log(`[SAFE-REMEDIATE] ✅ Executed:`, {
      finding_id,
